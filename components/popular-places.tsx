...
export function PopularPlaces() {
  ...
  return (
    <div className="w-full mx-auto h-full py-20 max-w-[90vw] flex flex-col justify-center align-middle items-center">
      <h2 className="max-w-xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
       Popular places to <span className="text-primary">visit.</span> 
      </h2>
